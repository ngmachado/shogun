...
export interface TestResolver extends BaseContract {
    ...
    functions: {
        ...
        addAdmin(_additionalAdmin: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        DEFAULT_ADMIN_ROLE(overrides?: CallOverrides): Promise<string>;
        addAdmin(_additionalAdmin: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        get(name: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        getRoleAdmin(role: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
        getRoleMember(role: PromiseOrValue<BytesLike>, index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        getRoleMemberCount(role: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
