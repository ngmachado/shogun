...
export interface ITOGAv2Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "withdrawFundsInCustody", values: [PromiseOrValue<string>]): string;
...
export interface ITOGAv2 extends BaseContract {
    ...
    functions: {
        ...
        withdrawFundsInCustody(token: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    changeExitRate(token: PromiseOrValue<string>, newExitRate: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        getDefaultExitRateFor(token: PromiseOrValue<string>, bondAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getMaxExitRateFor(token: PromiseOrValue<string>, bondAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        withdrawFundsInCustody(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
