...
export interface TestGovernance extends BaseContract {
    ...
    functions: {
        ...
        initialize(host: PromiseOrValue<string>, rewardAddress: PromiseOrValue<string>, liquidationPeriod: PromiseOrValue<BigNumberish>, patricianPeriod: PromiseOrValue<BigNumberish>, trustedForwarders: PromiseOrValue<string>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getRewardAddress(host: PromiseOrValue<string>, superToken: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        getSuperTokenMinimumDeposit(host: PromiseOrValue<string>, superToken: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        initialize(host: PromiseOrValue<string>, rewardAddress: PromiseOrValue<string>, liquidationPeriod: PromiseOrValue<BigNumberish>, patricianPeriod: PromiseOrValue<BigNumberish>, trustedForwarders: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<void>;
        isAuthorizedAppFactory(host: PromiseOrValue<string>, factory: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        isTrustedForwarder(host: PromiseOrValue<string>, superToken: PromiseOrValue<string>, forwarder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        owner(overrides?: CallOverrides): Promise<string>;
