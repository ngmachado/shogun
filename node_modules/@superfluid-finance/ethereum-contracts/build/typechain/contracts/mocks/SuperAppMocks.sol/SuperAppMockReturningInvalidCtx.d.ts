...
export interface SuperAppMockReturningInvalidCtxInterface extends utils.Interface {
    functions: {
        "afterAgreementCreated(address,address,bytes32,bytes,bytes,bytes)": FunctionFragment;
        "afterAgreementTerminated(address,address,bytes32,bytes,bytes,bytes)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "afterAgreementCreated" | "afterAgreementTerminated"): FunctionFragment;
...
//# sourceMappingURL=SuperAppMockReturningInvalidCtx.d.ts.map