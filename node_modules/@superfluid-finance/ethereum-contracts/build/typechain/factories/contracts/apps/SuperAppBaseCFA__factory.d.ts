...
import type { SuperAppBaseCFA, SuperAppBaseCFAInterface } from "../../../contracts/apps/SuperAppBaseCFA";
export declare class SuperAppBaseCFA__factory {
    ...
    static createInterface(): SuperAppBaseCFAInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): SuperAppBaseCFA;
}
//# sourceMappingURL=SuperAppBaseCFA__factory.d.ts.map